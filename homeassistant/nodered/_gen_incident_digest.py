...
SCRIPT = "/share/lucius_incident_digest.py"
SECRETS = "/share/lucius_secrets.json"
...
def live():
    ...
    return [
        tab(
            ...
            "21:00 local (HA clock) plus manual. Exec lucius_incident_digest.py: GET api/incident_digest.php, SMTP only if count>0. Copy homeassistant/incident_digest.py to /share/lucius_incident_digest.py. SMTP keys in /share/lucius_secrets.json. Companion: Lucius - Incident Digest Test. No HA Server field. python3 must exist on the Node-RED add-on (system_packages).",
        ),
