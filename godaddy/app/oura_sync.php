...
$haLatestByEndpoint = [];
foreach (['oura_push', 'pull_manual_data', 'status'] as $ep) {
...
<div class="wrap">
  ...
  <table class="day-table">
    <tbody>
      <?php
        $haLabels = ['oura_push' => 'Oura data push (every 4h)', 'pull_manual_data' => 'Manual data pull (every 15min)', 'status' => 'Status check'];
