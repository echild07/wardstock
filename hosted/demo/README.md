...
1. **cPanel → MySQL Databases**: create a second database + user with All Privileges, same as the real app's original setup (`hosted/README.md`'s "Setup (fresh install)" section) — just a different name, e.g. `wardstock_demo`.
